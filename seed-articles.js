...
const seedIntro = () => {
  const introData = {
    id: 1,
    title: `<p style="text-align:center;"><span style="font-size:30px;">Jenny's Blog</span></p>`,
    content: `<figure class="image"><img src="/img/jenny_image.png"></figure><p>&nbsp;</p><p style="text-align:center;">example@mail.com</p><p style="text-align:center;">&nbsp;</p><p style="text-align:center;">Welcome to my blog, jay :D :D !! I share recipies, life hacks and parenting tips to my readers. My blog is about my life and the things I experience , hence I love exchanging ideas and gain new perspectives from my audience. Come join me on my journey so that I can particiapte in yours! Life is all about the journey, so let’s talk ;)&nbsp;</p>`
  }
